...
class CreateMstVehiclesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('mst_vehicles', function (Blueprint $table) {
            ...
            $table->boolean('vehicles_kb')->nullable();
            $table->string('registration_numbers',50);
            $table->string('mst_business_office_id',5);
            $table->boolean('vehicle_size_kb')->nullable();
            $table->boolean('vehicle_purpose_id')->nullable();
            ...
            $table->boolean('vehicle_classification_id')->nullable();
            $table->boolean('private_commercial_id')->nullable();
            $table->boolean('car_body_shape_id')->nullable();
            $table->boolean('vehicle_id')->nullable();
            ...
            $table->boolean('kinds_of_fuel_id')->nullable();
