...
var ctrExpenseApplicationVl = new Vue({
  ...
  data: {
    ...
    getItems: function getItems(page, show_msg) {
      ...
      var that = this;
      that.loading = true;
      expense_application_service.loadList(data).then(function (response) {
    ...
    checkIsExist: function checkIsExist(id) {
      ...
      expense_application_service.checkIsExist(id).then(function (response) {
        if (!response.success) {
          alert(response.msg);
...
/***/ 25:
/*!*****************************************************************************!*\
  !*** multi ./resources/assets/js/controller/expense-application-list-vl.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
