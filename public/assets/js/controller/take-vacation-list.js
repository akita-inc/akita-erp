...
var ctrTakeVacationListVl = new Vue({
  ...
  data: {
    ...
    checkIsExist: function checkIsExist(id) {
      ...
      take_vacation_list_service.checkIsExist(id).then(function (response) {
        if (!response.success) {
          alert(response.msg);
  ...
  methods: {
    getItems: function getItems(page, show_msg) {
      ...
      var that = this;
      that.loading = true;
      take_vacation_list_service.loadList(data).then(function (response) {
...
module.exports = __webpack_require__(/*! D:\petproject\akita-erp\resources\assets\js\controller\take-vacation-list-vl.js */"./resources/assets/js/controller/take-vacation-list-vl.js");
