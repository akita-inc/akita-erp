...
var ctrAccountsPayableDataOutputVl = new Vue({
  ...
  methods: {
    ...
    getCurrentYearMonth: function getCurrentYearMonth() {
      var that = this;
      accounts_payable_data_output_service.getCurrentYearMonth().then(function (response) {
        that.fileSearch.billing_year = response.current_year;
        that.fileSearch.billing_month = response.current_month;
        that.handleEndDate();
      });
    },
    handleEndDate: function handleEndDate() {
      var that = this;
      var end_date = that.fileSearch.billing_year + '/' + that.fileSearch.billing_month + '/' + that.fileSearch.closed_date;
      that.fileSearch.end_date = moment__WEBPACK_IMPORTED_MODULE_4___default()(end_date).format('YYYY/MM/DD');
      that.fileSearch.start_date = moment__WEBPACK_IMPORTED_MODULE_4___default()(end_date).subtract(1, 'months').add(1, 'days').format('YYYY/MM/DD');
    }
  },
  mounted: function mounted() {
    this.getCurrentYearMonth();
...
/***/ 23:
/*!*********************************************************************************!*\
  !*** multi ./resources/assets/js/controller/accounts-payable-data-output-vl.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\petproject\akita-erp\resources\assets\js\controller\accounts-payable-data-output-vl.js */"./resources/assets/js/controller/accounts-payable-data-output-vl.js");
