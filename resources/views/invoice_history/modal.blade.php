    ...
    <div class="modal-dialog modal-lg" role="document" style="max-width:1250px;">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-delete"  {!! isset($attr_input) ? $attr_input:"" !!} v-on:click="openModalDelete(modal.invoice.invoice_number)" v-if="modal.sale_info.length > 0 && modal.sale_info[0].count_payment_histories == 0">{{trans("invoice_history.list.search.button.delete")}}</button>
