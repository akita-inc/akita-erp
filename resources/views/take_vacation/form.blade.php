@extends('Layouts.app')
@section('title',trans("take_vacation.create.title".$mode)))
@section('title_header',trans("take_vacation.create.title".$mode)))
@section('content')
    ...
    <div class="wrapper-container" id="ctrTakeVacationVl">
                ...
                @if($mode=='reservation' || $mode=='reservation_approval')
                    ...
                    <!--Block 1-->
                        <div class="grid-form">
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    @include('Component.form.input',['filed'=>'applicant_id','attr_input' => "maxlength='50'",'required'=>true])
                                </div>
                                <div class="col-md-8 col-sm-12">
                                    @include('Component.form.input',['class' =>'pl-0','filed'=>'staff_nm','attr_input' => "maxlength='50'"])
                                </div>
                                <div class="break-row-form"></div>
                                <div class="col-md-4 col-sm-12">
                                    @include('Component.form.input',['filed'=>'applicant_office_nm','attr_input' => "maxlength='50'",'required'=>true])
                                </div>
                                <div class="break-row-form"></div>
                                <div class="col-md-4 col-sm-12">
        ...
        @endif
        @if($role==1 && $mode=='reservation_approval')
            @include('Layouts.modal',['id'=> 'reservation_rejectModal','title'=> trans("take_vacation.modal.reservation_reject.title"),'content'=> trans("take_vacation.modal.reservation_reject.content"),'attr_input' => "@click='submit(1)'"])
        @endif
    </div>
@endsection
@section("scripts")
    <script>
        ...
        var business_ofice_nm = "<?php echo $businessOfficeNm; ?>";
