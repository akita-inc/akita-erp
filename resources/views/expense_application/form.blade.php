                        ...
                        <div class="grid-form">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    @include('Component.form.input',['filed'=>'cost','attr_input' => ""])
                                </div>
                                <div class="break-row-form"></div>
                                <div class="col-md-6 col-sm-12">
                                    @include('Component.form.input',['filed'=>'client_company_name','attr_input' => ""])
                                </div>
                                <div class="break-row-form"></div>
                                <div class="col-md-3 col-sm-12">
                                    @include('Component.form.input',['filed'=>'client_members_count', 'attr_input' => ""])
                                </div>
                                <div class="no-padding wd-32 lh-38 text-center">名</div>
                                <div class="col-md-7 col-sm-12">
                                    @include('Component.form.input',['class' => 'pl-0','filed'=>'client_members', 'attr_input' => ""])
                                </div>
                                <div class="break-row-form"></div>
                                <div class="col-md-3 col-sm-12">
                                    @include('Component.form.input',['filed'=>'own_members_count', 'attr_input' => ""])
                                </div>
                                <div class="no-padding wd-32 lh-38 text-center">名</div>
                                <div class="col-md-7 col-sm-12">
                                    @include('Component.form.input',['class' => 'pl-0','filed'=>'own_members', 'attr_input' => ""])
                                </div>
                                <div class="break-row-form"></div>
                                <div class="col-md-6 col-sm-12">
                                    @include('Component.form.input',['filed'=>'place','attr_input' => ""])
                                </div>
                                <div class="break-row-form"></div>
                                <div class="col-md-6 col-sm-12">
                                    @include('Component.form.textarea',['filed'=>'conditions','attr_input' => "maxlength='200' class='h-50'"])
                                </div>
                                <div class="break-row-form"></div>
                                <div class="col-md-6 col-sm-12">
                                    @include('Component.form.textarea',['filed'=>'conditions','attr_input' => "maxlength='200' class='h-50'"])
                                ...
                                <div class="break-row-form"></div>
                                <div class="col-md-6 col-sm-12">
                                    @include('Component.form.textarea',['filed'=>'purpose','attr_input' => "maxlength='200' class='h-50'"])
                                </div>
                                <div class="break-row-form"></div>
                                <div class="col-md-4 col-sm-12">
                                    @include('Component.form.radio',['class'=>'w-100','filed'=>'deposit_flg','array' => $listVacationIndicator,'role' => $mode=='register' || $mode=='edit' ? 1 :2 ])
                                </div>
                                <div class="col-md-4 col-sm-12">
                                    @include('Component.form.input',['class'=>'','filed'=>'deposit_amount'])
                                </div>
                            </div>
                        </div>
