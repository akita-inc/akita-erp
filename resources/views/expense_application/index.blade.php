...
@section('content')
    @include('Layouts.alert')
        <div class="row row-xs" id="ctrExpenseApplicationVl">
        <pulse-loader :loading="loading"></pulse-loader>
        <div class="sub-header">
            <div class="sub-header-line-one text-right">
                <button class="btn btn-yellow" onclick="window.location.href= '{{route('expense_application.create')}}'">
            ...
            <div class="sub-header-line-two p-t-30 frm-search-list">
                    ...
                    <div class="col-md-7 col-sm-12 row">
                        <div class="col-md-6 row">
                            <div class="col-md-4 col-list-search-f">
                                {{trans("expense_application.list.search.applicant_id")}}
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="col-md-6 row">
                            <div class="col-md-4 col-list-search-f">
                                {{trans("expense_application.list.search.applicant_nm")}}
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="col-md-7 row">
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" value="1" v-model="fileSearch.show_status" class="form-check-input">{{trans("expense_application.list.search.show_status")}}
                                </label>
                            </div>
                            <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" value="1" v-model="fileSearch.show_deleted" class="form-check-input">{{trans("expense_application.list.search.show_deleted")}}
                                </label>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-7 col-sm-12 row">
                        <div class="col-md-6 row">
                            <div class="col-md-4 col-list-search-f">
                                {{trans("expense_application.list.search.applicant_office_id")}}
                            </div>
                        ...
                        <div class="col-md-6 row">
                            <div class="col-md-4 col-list-search-f">
                                {{trans("expense_application.list.search.client_company_name")}}
                            </div>
                            <div class="col-md-8">
            ...
            <table class="table table-striped table-bordered search-content">
                ...
                <tr>
                    @foreach($fieldShowTable as $key => $field)
                        <th  v-on:click="sortList($event, '{{$field["sortBy"]}}')" id="th_{{$key}}" class="cursor-pointer {{ isset($field["classTH"])?$field["classTH"]:"" }}">{{trans("expense_application.list.table.".$key)}}</th>
                    @endforeach
                </tr>
                </thead>
                <tbody>
...
@section("scripts")
    ...
    <script type="text/javascript" src="{{ mix('/assets/js/controller/expense-application-list.js') }}" charset="utf-8"></script>
@endsection